...
select
    section_id,
    course_number,
    'Period '||period as name,
    'active' as status
from
    section_canvas_grouped
/*
where course_id IN ('250311.S1.590','803331.S1.580','803341.S1.580','803321.S1.580','42111de1.S1.517')
*/
